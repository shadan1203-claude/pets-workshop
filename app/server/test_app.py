...
"
    ...
    def _setup_query_mock(self, mock_query, dogs, total_count=None):
...
"
        ...
        mock_query_instance.count.return_value = total_count if total_count is not None else len(dogs)
